class WorkExperience < ApplicationRecord
  EMPLOYMENT_TYPE = %w[Full-time Part-time Self-employed Freelance Trainee Internship]
  ...
  def presence_of_end_date
    ...
    errors.add :end_date, 'must present if you are not currently working in this company'
  end
